...
public class FlashSaleService {
    ...
    public ReturnObject insertFlashsale(FlashSale flashSale) {
        ReturnObject<FlashSale> retObj=new ReturnObject<>();
        try {
            ...
            ReturnObject<FlashSalePo> flashSalePoReturnObject = flashsaleDao.selectByTimeAndId(flashSale.getFlashDate(), flashSale.getTimeSeq());
